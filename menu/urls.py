...
urlpatterns = [
    ...
    path(
        "public/shop/<int:shop_id>/categories/",
        PublicShopCategoryView.as_view()
    ),

    # OLD URL SUPPORT
    path(
        "shop/<int:shop_id>/categories/",
        PublicShopCategoryView.as_view()
    ),

    path(
        "public/items/",
        PublicMenuItemListView.as_view()
    ),
    ...
    path(
        "public/category/<int:category_id>/items/",
        PublicCategoryItemsView.as_view()
    ),
